...
require_once('./Tools/page.class.php'); //分页类
$db =  MysqlDB::GetDB($config);
$sql = 'select * from p38_goods';
$total = $db->getTotalNum($db->link, $sql); //记录总数
$showrow = 1; //一页显示的行数
                    ...
                    <ul class="dates">
                        <?php foreach ($data as $v) {  ?>
                            <li>
                                ...
                                <a target="_blank" href="http://www.sucaihuo.com/js"><?php echo $v['goods_desc'] ?></a>
                            </li>
                        <?php } ?>
                    </ul>
                    <!--显示数据区-->
